...
{
    public class WriteSimpleText : Command
    {
        public WriteSimpleText()
        {
            Instance = this;
        }

        ///<summary>The only instance of the Test_WriteSimpleText command.</summary>
        public static WriteSimpleText Instance { get; private set; }

        public override string EnglishName => "WriteSimpleText";
        ...
        protected override Result RunCommand(RhinoDoc doc, RunMode mode)
        {
            ...
            var startInfo = new ProcessStartInfo
            {
                ...
                Arguments = @"/C echo something > stepsTest.txt"
            };
