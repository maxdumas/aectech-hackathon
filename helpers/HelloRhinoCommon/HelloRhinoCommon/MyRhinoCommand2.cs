...
namespace HelloRhinoCommon
{
    public class MyRhinoCommand2 : Command
    {
        ...
        ///<summary>The only instance of the MyRhinoCommand2 command.</summary>
        ...
        protected override Result RunCommand(RhinoDoc doc, RunMode mode)
        {
            ...
            var startInfo = new ProcessStartInfo
            {
                ...
                Arguments = @"/C ""C:\Program Files (x86)\DVC (Data Version Control)\dvc"" dag --mermaid > dagTest.mermaid"
            };
